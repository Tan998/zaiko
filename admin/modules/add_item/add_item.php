	    	...
	    	<form method="POST" action="<?php echo create_link(base_url('admin/index.php'), array('m' => 'add_item', 'a' => 'add_item_check')); ?>" >
	    		<div class="container">
	    			<div class="col-12 d-flex justify-content-between row">
			    		...
			    		<input class="col-5 my-2" type="number" min="1" max="999" required name="add_item_number" placeholder="入庫数を入力してください。" value="" class="form-control" id="add_item_value">
			    		<div class="text-end">
			    			<input class=" my-2 btn btn-success" type="submit" name="add_item_check" value="登録完了へ">
				    	</div>
			    	</div>
	    		</div>
