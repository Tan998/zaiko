...
<div class="container">
    <div class="controls row">
        ...
        <div class="col-10 col-md-8 shadow p-3 mb-5 bg-body rounded">
            <form id="main-form" method="post" action="<?php echo create_link(base_url('admin/index.php'), array('m' => 'action_qr_mana', 'a' => 'add_qr')); ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" class="form-control" id="code_value" name="bin_code" value="<?php echo input_post('bin_code'); ?>">
