...
if (isset($_POST['remove_item_check'])) {
	...
	if (($zaikosuu - $remove_item_number) < 0) {
		//redirect(base_url('admin'), array('m' => 'common', 'a' => 'logout'));
...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
	  <ol class="breadcrumb">
	    ...
	    <li class="breadcrumb-item"><a href="<?php echo create_link(base_url('admin/index.php'), array('m' => 'add_item', 'a' => 'add_item')); ?>">コードのスキャン</a></li>
	    <li class="breadcrumb-item active" aria-current="page">入庫情報のチェック</li>
	  </ol>
	</nav>
	...
	<div class="px-5 py-2">
			...
			<form id="main-form" method="post" onsubmit="return confirm('この情報で出庫しますか？');" action="<?php echo create_link(base_url('admin/index.php'), array('m' => 'remove_item', 'a' => 'remove_item_check')); ?>">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" id="memo" placeholder="出庫メモを入力" name="memo" value=""><?php print(input_post('memo')); ?></textarea>
				...
				<div class="row">
					<div class="col-12 mb-3">
						...
						<span class="badge rounded-pill bg-danger" style="font-size: 10px;">必須</span>
						<input disabled type="text" class="form-control" id="bin_code_val" value="<?php print(input_post('bin_code_val')); ?>">
					...
					<div class="col-12 col-sm-6 mb-3">
						<label for="remove_item_number" class="form-label bg-light bg-gradient rounded-pill text-center px-1"><strong>出庫数</strong></label>
						<span class="badge rounded-pill bg-danger" style="font-size: 10px;">必須</span>
						<input disabled type="text" class="form-control" id="remove_item_number" value="<?php print(input_post('remove_item_number')); ?>">

						<input hidden type="text" name="remove_item_number" value="<?php print(input_post('remove_item_number')); ?>">
						<input hidden type="text" name="MaHang" value="<?php print(input_post('bin_code_val')); ?>">
						<input hidden type="text" name="bin_code_val" value="<?php print(input_post('bin_code_val')); ?>">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" id="shiiretanka" name="shiiretanka" value="<?php print(input_post('shiiretanka')); ?>">
				...
				<div class="mb-3">
					<a class="btn btn-success" onclick="$('#main-form').submit()" href="#">出庫完了</a>
