...
<h1>メンバーを追加</h1>
    <nav class="mt-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo create_link(base_url('admin/index.php'), array('m' => 'user', 'a' => 'list')); ?>">ユーザー管理</a></li>
        <li class="breadcrumb-item active" aria-current="page">ユーザーの登録</li>
      </ol>
    </nav>
<div class="container">
    <div class="controls row">
        ...
        <div class="col-10 col-md-8 shadow p-3 mb-5 bg-body rounded">
            <form id="main-form" method="post" action="<?php echo create_link(base_url('admin/index.php'), array('m' => 'user', 'a' => 'add')); ?>">
              <div class="mb-3">
                <label for="input-name" class="form-label">ユーザー名</label>
                <input type="text" class="form-control" id="input-name" name="username" autocomplete="on" value="<?php echo input_post('username'); ?>" />
                <?php show_error($error, 'username'); ?>
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">パスワード</label>
                <input required type="password" class="form-control" id="exampleInputPassword1" autocomplete="new-password" name="password" value="<?php echo input_post('password'); ?>" placeholder="パスワードは半角英数字6文字以上、16文字以内で入力してください。"/>
                <?php show_error($error, 'password'); ?>
              </div>
                <div class="mb-3">
                <label for="exampleInputPassword2" class="form-label">確認用パスワード<small class="text-muted">（上のパスワードと同じ）</small></label>
                <input required type="password" class="form-control" id="exampleInputPassword2" autocomplete="new-password" name="re_password" value="<?php echo input_post('re_password'); ?>" placeholder="パスワードは半角英数字6文字以上、16文字以内で入力してください。"/>
                ...
                <div class="mb-3">
                    <label for="input-fullname" class="form-label">氏名</label>
                ...
                <div class="mb-3">
                    <label for="form-select" class="form-label">役割を選択</label>
