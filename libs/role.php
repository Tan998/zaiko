...
// gioi han trong 30p khong hoat dong se ket thuc phien dang nhap
function set_logged_timeout(){
    if (is_logged()) {
        ...
        session_unset();
        session_destroy();
        echo '<script language="javascript">alert("30分以上サイトと操作しなかった。\nログインしてください。"); window.location.href = "'.create_link(base_url('admin'), array('m' => 'common', 'a' => 'login')).'";</script>';
